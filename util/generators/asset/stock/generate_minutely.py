...
def main():
    ...
    for ticker_symbol in ticker_symbols:
        ...
        output_file_path = f'{repo_path}/etl/asset/stock/{ticker_symbol.lower()}/minutely/config.yml'
        ...
        with open('templates/config_template_minutely.yml', 'r') as template_file:
